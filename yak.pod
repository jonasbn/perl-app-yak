...
=item * L<Parse::Gitignore|https://metacpan.org/pod/Parse::Gitignore>
...
=item * C<yak> is specified to a minimum requieremet of Perl 5.10, based on analysis by L<Perl::MinimumVersion>, implementation syntax requires Perl 5.8.0, so C<yak> I<could work> for 5.8.0
...
=item * The YAML implementation is based on L<YAML::Tiny|https://metacpan.org/pod/YAML::Tiny> and is therefor limited to this more simple implementation, which was however deemed sufficient for B<Yak>.
...
Image used on the B<yak> L<website|https://jonasbn.github.io/perl-app-yak/> is under copyright by L<Shane Aldendorff|https://unsplash.com/photos/3b3O75X0Jzg>
